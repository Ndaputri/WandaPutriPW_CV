    ...
    <section id="home" class="container mx-auto text-center py-12 md:py-16 px-4">
        <div class="hero-gradient rounded-2xl py-12 md:py-16 px-6 shadow-xl fade-in-up">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="MIHidayatulUlumSambong/#home/formulir" class="btn-primary bg-orange-500 text-white px-8 py-3 rounded-full hover:bg-orange-600 transition flex items-center justify-center gap-2 font-semibold shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div class="order-1 md:order-2 flex justify-center">
                <div class="bg-green-100 rounded-2xl p-6 text-center">
                    ...
                    <a href="MIHidayatulUlumSambong/#home/formulir" class="inline-block bg-orange-500 text-white px-6 py-2 rounded-full hover:bg-orange-600 transition mt-3">
