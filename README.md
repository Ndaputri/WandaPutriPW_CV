    ...
    <section id="home" class="container mx-auto text-center py-12 md:py-16 px-4">
        <div class="hero-gradient rounded-2xl py-12 md:py-16 px-6 shadow-xl fade-in-up">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="ndaputri.github.io/MIHidayatulUlumSambong/<?=%20base_url();?/MIHidayatulUlumSambong/#info/formulir" class="btn-primary bg-orange-500 text-white px-8 py-3 rounded-full hover:bg-orange-600 transition flex items-center justify-center gap-2 font-semibold shadow-lg">
